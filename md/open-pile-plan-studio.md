...
**Current version:** v0.3.3-alpha (2026-09-11)
...
- Latest stable release: https://github.com/OpenAEC-Foundation/pile-plan-studio/releases/tag/v0.3.3-alpha
...
- [Windows · Pile.Plan.Studio_0.3.1_x64-setup.exe](https://github.com/OpenAEC-Foundation/pile-plan-studio/releases/download/v0.3.1-alpha/Pile.Plan.Studio_0.3.1_x64-setup.exe) (v0.3.1-alpha — 4.4 MB)
